...
| Constraints, support level 4 | Constraints are supported with support for basic functions and all logical expressions from Udf-expression language | `{myfield <String And In("bin", "bai", "baa")>: "my-value"}`
